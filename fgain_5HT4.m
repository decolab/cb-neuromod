...
%%  OPTIMIZATION FOR LSD RECEPTORS 5HT4
...
Receptor = symm_mean5HT4(:,1)/max(symm_mean5HT4(:,1));
...
FCDfitt_rcpT4 = FCDfitt;
fitting_rcpT4 = fitting;

save('fgain_rcpT4.mat','WG','FCDfitt_rcpT4','fitting_rcpT4');
