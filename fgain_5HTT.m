...
%%  OPTIMIZATION FOR LSD RECEPTOR 5HTT
%
...
Receptor = symm_mean5HTT(:,1)/max(symm_mean5HTT(:,1));
...
FCDfitt_rcpTT = FCDfitt;
fitting_rcpTT = fitting;

save('fgain_rcpTT.mat','WG','FCDfitt_rcpTT','fitting_rcpTT');
