...
%%  GENERALIZATION CAPABILITY: OPTIMIZATION LSD TEST SET (OTHER 50% OF THE SUBJECTS)
%
...
%% Load Trainning and Test sets

load testSUBJ.mat;

NSUB     = size(testSUBJ,2);
...
kk3 = 1;
for nsub = 1:NSUB
    signaldata = eval(sprintf('TC%d', testSUBJ(nsub)));
...
FCDfitt_test = FCDfitt;
fitting_test = fitting;

save('LSD_test.mat','WG','FCDfitt_test','fitting_test');
